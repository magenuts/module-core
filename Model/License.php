...
class License
{
    ...
    public function load($className = '')
    {
        ...
        if ($module == 'Magenuts_Blog' || $module == 'Magenuts_Demo' || $module == 'Magenuts_Profiler') {
            return true;
        }
    ...
    public function getStatus($className = '')
    {
        ...
        if (strpos($this->getDomain(), 'magenuts.com') !== false) {
            return true;
        }
    ...
    private function request()
    {
        ...
        $result = $this->sendRequest('https://lc.magenuts.com/lc/check/', $params);
    ...
    public function getRequestUrl()
    {
        ...
        return 'https://lc.magenuts.com/lc/check/?' . $query;
    }
