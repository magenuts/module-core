...
use Magenuts\Core\Api\UrlRewriteHelperInterface;
use Magenuts\Core\Model\ResourceModel\UrlRewrite\CollectionFactory as UrlRewriteCollectionFactory;
use Magenuts\Core\Model\UrlRewriteFactory;
    ...
    public function getUrl($module, $type, $entity = null)
    {
        if ($this->isEnabled($module)) {
            ...
            if ($entity) {
                ...
                if ($collection->count()) {
                    /** @var \Magenuts\Core\Model\UrlRewrite $rewrite */
