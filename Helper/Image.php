...
use Magenuts\Core\Api\ImageHelperInterface;
use Magenuts\Core\Model\ImageFactory;
...
class Image extends AbstractHelper implements ImageHelperInterface
{
     ...
     * Image Model
     *
     * @param \Magenuts\Core\Model\Image $model
     * @return $this
     */
     ...
     * Image model
     *
     * @return \Magenuts\Core\Model\Image
     */
