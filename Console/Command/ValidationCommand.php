...
namespace Magenuts\Core\Console\Command;

use Magenuts\Core\Api\Service\ValidatorInterface;
use Magenuts\Core\Service\ValidationService;
...
{
    const COMPANY_NAMESPACE = 'Magenuts';
    ...
    /**
     * @var \Magenuts\Core\Api\Service\ValidationServiceInterface
     */
    ...
    {
        $this->setName('magenuts:validate')
            ->setDescription('Validate Magenuts Extensions')
